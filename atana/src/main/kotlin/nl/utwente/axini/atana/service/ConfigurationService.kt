...
class ConfigurationService {
    ...
    /**
     * This variable shows if the config is "fresh". A config is "fresh" is has not yet been used by any grouping or analysis service during configuration. When the service is configured, the config is not fresh anymore until an new config is uploaded.
     */
